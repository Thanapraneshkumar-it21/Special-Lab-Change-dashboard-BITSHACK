				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Application Type</b></label>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Worked Period</b></label>
						...
						<div class="form-group row">
								<label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Incharge Remarks</b></label>
								<div class="col-sm-12 col-md-10">
									<?php
