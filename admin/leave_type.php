...
<?php 
	 if (isset($_GET['delete'])) {
		...
		if ($result) {
			echo "<script>alert('Application Type deleted Successfully');</script>";
			...
			<div class="min-height-200px">
					...
					<div class="row">
							...
							<div class="card-box pd-30 pt-10 height-100-p">
								...
								<section>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="leavetype" type="text" class="form-control" required="true" maxlength="30" autocomplete="off">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea name="description" maxlength="50" style="height: 5em;" class="form-control text_area" type="text"></textarea>
											</div>
										</div>
									</div>
									...
									<div class="col-sm-12 text-right">
										<div class="dropdown">
										   <input class="btn btn-primary" type="submit" value="SAVE" name="add" id="add">
									    </div>
									</div>
								   </form>
							    </section>
						...
						<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Available Lab List</h2>
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										<thead>
										<tr>
											<th class="table-plus">AVAILABLE LAB</th>
