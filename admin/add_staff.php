		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">People Module</h4>
							<p class="mb-20"></p>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="password" type="password" placeholder="Enter a Strong Password" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="phonenumber" type="tel" class="form-control" required="true"  maxlength="10" pattern="[0-9]{10}"  autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Roll No :</label>
											<input name="address" type="text" class="form-control" maxlength="13" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="user_role" class="custom-select form-control" required="true" autocomplete="off">
												...
												<option value="Admin">Special Lab Head</option>
												<option value="HOD">Special Lab Incharge</option>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_staff" id="add_staff" data-toggle="modal">ADD PERSON&nbsp;</button>
											</div>
										</div>
									</div>
								</div>
