		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Edit People</h4>
							<p class="mb-20"></p>
						</div>
					</div>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="phonenumber" type="number" class="form-control"   pattern="[0-9]{10}"required="true" autocomplete="off"value="<?php echo $row['Phonenumber']; ?>">
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Roll No :</label>
											<input name="address" type="text" class="form-control" required="true" maxlength="13" autocomplete="off"value="<?php echo $row['Address']; ?>">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="add_staff" id="add_staff" data-toggle="modal">SAVE&nbsp;</button>
											</div>
										</div>
									</div>
								</div>
