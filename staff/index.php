...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/lablogo.png" alt="" height="100" width="100"></div>
	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4 user-icon">
						<img src="../vendors/images/lablogo.png" alt="" height="100" width="100">
					</div>
					<div class="col-md-8">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">APPLICATION HISTORY</h2>
				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus">SELECTED LAB</th>
								<th>DATE OF JOIN</th>
								<th>DATE OF RESIGN()</th>
								<th>LAB INCHARGE STATUS</th>
