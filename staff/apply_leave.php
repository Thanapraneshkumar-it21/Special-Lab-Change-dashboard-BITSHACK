...
<?php
	...
	elseif($leave_days <= 0)
	{
	    echo "<script>alert('YOU HAVE EXCEEDED YOUR LEAVE LIMIT.APPLICATION FAILED');</script>";
	  }
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Fill the Form to Change your Special Lab</h4>
							</div>
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label>Date of Resign(Form Submission Date) :</label>
